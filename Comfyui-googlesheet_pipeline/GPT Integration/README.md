...
This project connects **Google Sheets** to **ComfyUI** (a local Stable Diffusion workflow engine) with HPC cluster(Pegasus) and uploads generated images to **AWS S3**, automatically updating the Sheet with live previews.
